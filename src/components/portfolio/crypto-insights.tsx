...
export function CryptoInsights({
  holdings,
  totalValue,
  userId,
}: CryptoInsightsProps) {
  const [insights, setInsights] = useState<CryptoInsightsData | null>(null);
  ...
  if (holdings.length === 0) {
    return (
      <div className="text-center py-8 text-muted-foreground">
        ...
        <p>Add crypto holdings to get AI-powered insights</p>
      </div>
    );
  }
    ...
    return (
      <div className="space-y-4 py-4">
        <div className="flex items-center justify-center gap-2 text-muted-foreground">
          ...
          <span>Analyzing your crypto portfolio...</span>
        </div>
    ...
    <div className="space-y-6 py-2">
      ...
      <div>
        ...
        <ul className="space-y-2">
          {insights.recommendations.map((rec, i) => (
            <li
              key={i}
              className="text-sm bg-orange-50 dark:bg-orange-950/30 text-orange-900 dark:text-orange-100 rounded-md p-2"
            >
              {rec}
            </li>
          ))}
      ...
      <div className="pt-4 border-t">
        ...
        <div className="flex gap-2">
          <Input
            placeholder="Ask about your crypto holdings..."

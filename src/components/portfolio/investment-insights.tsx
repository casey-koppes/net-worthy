  ...
  if (!hasGenerated && !isLoading) {
    return (
      <div className="text-center py-8">
        <Lightbulb className="h-12 w-12 mx-auto mb-4 text-primary opacity-70" />
        <h4 className="font-semibold mb-2">AI Portfolio Analysis</h4>
        <p className="text-sm text-muted-foreground mb-4 max-w-sm mx-auto">
          Get personalized insights, a portfolio grade, and recommendations based on
